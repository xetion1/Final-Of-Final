...
export const fetchConfluencePageContent = async (CONFLUENCE_URL, CONFLUENCE_USER, CONFLUENCE_API_TOKEN, CONFLUENCE_PAGE_ID) => {
...
export const updateConfluencePageContent = async (CONFLUENCE_URL, CONFLUENCE_USER, CONFLUENCE_API_TOKEN, CONFLUENCE_PAGE_ID, content, currentPageVersion) => {
    const confluenceAPI = createConfluenceAPI(CONFLUENCE_URL, CONFLUENCE_USER, CONFLUENCE_API_TOKEN);
    try {
        const updateData = {
...
export const getCurrentPageVersion = async (CONFLUENCE_URL, CONFLUENCE_USER, CONFLUENCE_API_TOKEN, CONFLUENCE_PAGE_ID) => {
    const confluenceAPI = createConfluenceAPI(CONFLUENCE_URL, CONFLUENCE_USER, CONFLUENCE_API_TOKEN);
    try {
